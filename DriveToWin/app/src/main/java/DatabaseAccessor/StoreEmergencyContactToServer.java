...
/**
 * Created by Ashwin Kumar on 07-03-2015.
 */
public class StoreEmergencyContactToServer extends AsyncTask<EmergencyContacts,Void,String> {
    private Context context;
    public StoreEmergencyContactToServer(Context context){
    ...
    protected String doInBackground(EmergencyContacts...emergencyContacts){
        ...
        try{
            ...
            HttpPost postRequest = new HttpPost("http://cs.okstate.edu/~tashwin/DriveToWin/AddEmergencyContacts.php");
            ...
            list.add(new BasicNameValuePair("emergency_contact_name",em_contact.Get_NAME()));
            list.add(new BasicNameValuePair("emergency_contact_phone_num",em_contact.Get_E_MAIL()));
            list.add(new BasicNameValuePair("emergency_contact_e_mail",em_contact.Get_PHONE_NUMBER()));
