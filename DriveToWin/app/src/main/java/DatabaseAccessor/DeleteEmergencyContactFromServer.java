 ...
 */
public class DeleteEmergencyContactFromServer extends AsyncTask<EmergencyContacts,Void,String> {
    private Context context;
    public DeleteEmergencyContactFromServer(Context context){
    ...
    protected String doInBackground(EmergencyContacts...emergencyContacts){
        ...
        try{
            ...
            HttpPost postRequest = new HttpPost("http://cs.okstate.edu/~tashwin/DriveToWin/deleteEmergencyContacts.php");
